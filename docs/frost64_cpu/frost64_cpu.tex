...
\section{Instructions (CPU's perspective)}
	...
	\subsection{Group 5 Instructions}
		...
		\item Instruction List:
			...
			%		\texttt{iB} at index \texttt{imm6} .
			%	%--------
			%	\end{itemize}
			%\item \texttt{jzo.v dA, iB, imm6}
			%	\begin{itemize}
			%	%--------
